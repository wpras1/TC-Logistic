            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Outgoing Goods</h1>
                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="date_out" id="date_out" class="form-control" value="{{ $outcomingGoods->date_out }}" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="quantity" id="quantity" class="form-control" value="{{ $outcomingGoods->quantity }}" required>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="destination">Destination of Goods</label>
                                                    <input type="text" name="destination" id="destination" class="form-control" value="{{ $outcomingGoods->destination }}" required>
                                                </div>
                                            </div>
                                        </div>
